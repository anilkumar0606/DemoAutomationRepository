...
public class Assignment2 
{
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateuserFirstname().sendKeys("Megu");
			oPage.getCreateUserLastName().sendKeys("Reddy");
			Thread.sleep(2000);
			oPage.getCreateUserEmail().sendKeys("megu@gmail.com");
			oPage.getCreateUsername().sendKeys("megu");
			oPage.getCreateUserpassword().sendKeys("654321");
			oPage.getCreateUserConfirmPassword().sendKeys("654321");
